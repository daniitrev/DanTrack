        ...
        pipe(
          switchMap((payload) => {
            ...
            return loadStateEntity$<ReportsSummaryResponse | null>({
              ...
              fetch$: () =>
                api.get<ReportsSummaryResponse | null>(`/api/v1/reports/summary${query}`),
        ...
        pipe(
          switchMap((payload) => {
            ...
            return loadStateEntity$<ReportsByProjectResponse | null>({
              ...
              fetch$: () =>
                api.get<ReportsByProjectResponse | null>(`/api/v1/reports/by-project${query}`),
        ...
        pipe(
          switchMap((payload) => {
            ...
            return loadStateEntity$<ReportsByMemberResponse | null>({
              ...
              fetch$: () =>
                api.get<ReportsByMemberResponse | null>(`/api/v1/reports/by-member${query}`),
        ...
        pipe(
          switchMap((payload) => {
            ...
            return loadStateEntity$<ReportsDailyResponse | null>({
              ...
              fetch$: () => api.get<ReportsDailyResponse | null>(`/api/v1/reports/daily${query}`),
